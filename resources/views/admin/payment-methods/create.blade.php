...
@section('title', __('app.add_payment_method'))
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400">
                        {{ __('app.create_new_payment_method_description') }}
                    </p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <select id="type" 
                                ...
                                <option value="visa" {{ old('type') == 'visa' ? 'selected' : '' }}>فيزا</option>
                                <option value="mastercard" {{ old('type') == 'mastercard' ? 'selected' : '' }}>ماستركارد</option>
                                <option value="bank" {{ old('type') == 'bank' ? 'selected' : '' }}>تحويل بنكي</option>
                                <option value="cash" {{ old('type') == 'cash' ? 'selected' : '' }}>نقدية</option>
                                <option value="crypto" {{ old('type') == 'crypto' ? 'selected' : '' }}>كريبتو</option>
                                <option value="mobile" {{ old('type') == 'mobile' ? 'selected' : '' }}>دفع عبر الهاتف</option>
                                <option value="paypal" {{ old('type') == 'paypal' ? 'selected' : '' }}>باي بال</option>
                                <option value="wallet" {{ old('type') == 'wallet' ? 'selected' : '' }}>محفظة رقمية</option>
                                <option value="gift" {{ old('type') == 'gift' ? 'selected' : '' }}>بطاقة هدايا</option>
                                <option value="digital" {{ old('type') == 'digital' ? 'selected' : '' }}>نقود إلكترونية</option>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           value="none" 
                                           id="field_none" 
                                           {{ in_array('none', old('input_field_type', ['none'])) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           {{ in_array('sender_name', old('input_field_type', [])) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           {{ in_array('sender_phone', old('input_field_type', [])) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           {{ in_array('card_number', old('input_field_type', [])) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           value="bank_name" 
                                           id="field_bank_name"
                                           {{ in_array('bank_name', old('input_field_type', [])) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           {{ in_array('account_number', old('input_field_type', [])) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           {{ in_array('transaction_id', old('input_field_type', [])) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           {{ in_array('wallet_address', old('input_field_type', [])) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           {{ in_array('mobile_number', old('input_field_type', [])) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           value="amount" 
                                           id="field_amount"
                                           {{ in_array('amount', old('input_field_type', [])) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           {{ in_array('receipt_upload', old('input_field_type', [])) ? 'checked' : '' }}>
