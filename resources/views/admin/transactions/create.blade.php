...
@section('title', __('app.add_transaction'))
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400">
                        {{ __('app.create_new_transaction_description') }}
                    </p>
                </div>
                ...
                <form action="{{ route('admin.transactions.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" 
                                ...
                                <option value="failed" {{ old('status') == 'failed' ? 'selected' : '' }}>{{ __('app.failed') }}</option>
                    ...
                    <div class="form-group mt-6">
                        ...
                        <textarea id="payment_data" 
                                  ...
                                  placeholder="{{ __('app.payment_data_placeholder') }}">{{ old('payment_data') }}</textarea>
